...
metadata_path = 'infographicsVQA_train_v1.0.json'

# test Image 数据
h5_path = 'test_pid_image.h5'
metadata_path = 'infographicsVQA_test_v1.0.json'

# val Imgae 数据
h5_path = 'val_pid_image.h5'
metadata_path = '/mnt/data/user/tc_agi/xubokai/infographicsqa/infographicsVQA_val_v1.0_withQT.json'

# 原始 Image
image_source_path = '/mnt/data/user/tc_agi/xubokai/infographicsqa/infographicsvqa_images.tar.gz'
...
print(f"image_path_2_docId = {image_path_2_docId}")
