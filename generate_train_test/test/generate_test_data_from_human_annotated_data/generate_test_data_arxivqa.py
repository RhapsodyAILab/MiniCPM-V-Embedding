...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/arxivqa-test_query'
    test_jsonl_path = f'/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/test.jsonl'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/test_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/xubokai/ocr_output_0717_pytesseract_human_data/arxivqa_new_new-test_pid_image'
    docid_cnt = {}
