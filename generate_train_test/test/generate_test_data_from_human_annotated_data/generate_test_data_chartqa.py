...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/chartqa-test_human-query'
    test_json_path = f'/mnt/data/user/tc_agi/xubokai/ChartQA/test_human.json'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/ChartQA/test_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/xubokai/ocr_output_0717_pytesseract_human_data/ChartQA-test_pid_image'
    docid_cnt = {}
