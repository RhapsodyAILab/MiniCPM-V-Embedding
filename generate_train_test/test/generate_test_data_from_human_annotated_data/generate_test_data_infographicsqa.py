...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/tcy6/query_cls_result/infographicsVQA_val_v1'
    test_json_path = f'/mnt/data/user/tc_agi/xubokai/{dataset_name}/infographicsVQA_val_v1.0_withQT.json'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/{dataset_name}/val_pid_image.h5'
    error_cnt = 0
    if (doc_type == 'ocr'):
        output_dir = f'/home/jeeves/tcy6/test_data_{doc_type}/{ocr_type}/{dataset_name}'
    else:
        output_dir = f'/home/jeeves/tcy6/test_data_{doc_type}/{dataset_name}'
    ocr_path = f'/home/jeeves/tcy6/ocr_output_0811_pytesseract/infographicsqa-val_pid_image'
    docid_cnt = {}
    ...
    with open(test_json_path, "r", encoding='utf-8') as test_json_file:
        datas = json.load(test_json_file)
        datas = datas['data']
        for line in datas:
            data = line
            query = data["question"]
            ...
            if (docid not in ocr_result):
                continue
                
            if (docid_cnt[docid] == 2):
                if (doc_type == 'image'):
