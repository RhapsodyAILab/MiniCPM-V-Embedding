...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/slidevqa-test_query'
    test_jsonl_path = f'/mnt/data/user/tc_agi/xubokai/slidevqa/test_formal.jsonl'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/slidevqa/test_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/xubokai/ocr_output_0717_pytesseract_human_data/slidevqa-test_pid_image'
    docid_cnt = {}
