...
input_dir = '/home/jeeves/rag-v-common/query_cls_result/arxivqa-train_query'
source_path = '/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/train.jsonl'
h5_path = '/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/train_pid_image.h5'
output_dir = '/home/jeeves/train_data_image/arxivqa_new_new'
index = 0
batch_index = 0
line_cnt = 0
batch_size = 128
