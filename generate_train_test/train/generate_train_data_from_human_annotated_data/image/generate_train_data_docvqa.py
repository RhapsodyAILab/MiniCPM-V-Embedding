...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/rag-v-common/query_cls_result/docvqa_mp_train'
    train_json_path = f'/home/jeeves/{dataset_name}/train.json'
    h5_path = f'/home/jeeves/{dataset_name}/train_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/ocr_output_0702/{dataset_name}'
    ...
    with open(train_json_path, "r", encoding='utf-8') as train_json_file:
        ...
        for line in datas:
            ...
            if (filter_dict[query] == 'B'):
                continue
            docid = data['page_ids'][data['answer_page_idx']]
            if dataset_type == 'sdmq':
                ...
                if (query not in data_pool):
                    data_pool[query] = []
            if (doc_type == 'image'):
                image = h5_file[f'{docid}.jpg//image']
                image = image[()]
                systhesize_data = {
                    'index': 0,
