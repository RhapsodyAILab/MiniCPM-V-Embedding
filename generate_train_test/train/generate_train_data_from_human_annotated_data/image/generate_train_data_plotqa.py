...
input_dir = '/home/jeeves/rag-v-common/query_cls_result/plotqa-qa_pairs_V1_train_sampled-query'
source_path = '/mnt/data/user/tc_agi/xubokai/plot_qa/qa_pairs_V1_train_sampled.jsonl'
h5_path = '/mnt/data/user/tc_agi/xubokai/plot_qa/train_pid_image.h5'
output_dir = '/home/jeeves/preprocessed_train_data/plot_qa'
index = 0
batch_index = 0
line_cnt = 0
batch_size = 128
...
with h5py.File(h5_path) as h5_file, \
    ...
    for line1, line2 in zip(source_file, all_json_file):
        data1 = json.loads(line1)
        data2 = json.loads(line2)
        if (data2['response'] == "A"):
            query = data2["query"]
            doc_id = data1["image_index"]
            image = h5_file[f'{doc_id}.png//image']
            image = image[()]
