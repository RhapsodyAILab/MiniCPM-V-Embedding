...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/arxivqa-train_query'
    train_jsonl_path = f'/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/train.jsonl'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/arxivqa_new_new/train_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/xubokai/captioner_output/{dataset_name}_train'
