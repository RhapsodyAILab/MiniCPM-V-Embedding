...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/chartqa-train_human-query'
    train_json_path = f'/mnt/data/user/tc_agi/xubokai/ChartQA/train_human.json'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/ChartQA/train_pid_image.h5'
    if (doc_type == 'ocr'):
        output_dir = f'/home/jeeves/xubokai/train_data_{doc_type}/{ocr_type}/{dataset_name}'
    else:
        output_dir = f'/home/jeeves/xubokai/train_data_{doc_type}/{dataset_name}'
    ocr_path = f'/home/jeeves/xubokai/captioner_output/ChartQA_train'
    ...
    data_pool = {}
    with open(train_json_path, "r", encoding='utf-8') as train_json_file:
        datas = json.load(train_json_file)
        for line in datas:
            data = line
            query = data["query"]
