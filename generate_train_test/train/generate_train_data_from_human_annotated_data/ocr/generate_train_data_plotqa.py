...
if __name__ == '__main__':
    ...
    filter_dir = f'/home/jeeves/xubokai/query_cls_result/plotqa-qa_pairs_V1_train_sampled-query'
    train_jsonl_path = f'/mnt/data/user/tc_agi/xubokai/plot_qa/qa_pairs_V1_train_sampled.jsonl'
    h5_path = f'/mnt/data/user/tc_agi/xubokai/plot_qa/train_pid_image.h5'
    if (doc_type == 'ocr'):
    ...
    ocr_path = f'/home/jeeves/xubokai/captioner_output/plot_qa_train'
